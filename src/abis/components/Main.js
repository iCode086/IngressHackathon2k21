...
import Button from "/Users/divita/Downloads/gg/src/components/Button/Button.js";
import Button2 from "/Users/divita/Downloads/gg/src/components/Button/Button2.js";
        ...
        return  <h2 className="text-white text-monospace bg-dark"><b><ins>SIGNUP</ins></b></h2> 
              ...
              <table className="table-sm table-bordered text-monospace" style={{ width: '1000px', maxHeight: '450px'}}>
                ...
                <input
                        ...
                        placeholder =""
                        />
                  <h3 className="text-center text-white text-monospace bg-dark">FUNDRAISER</h3>
                  
                  {/* <p className="text-white text-monospace bg-dark">{ this.props.acc }</p> */}
                {/* <input type="file" onChange={this.props.captureFile} className="text-white text-monospace"/> */}
                <button type="submit" className="btn-primary btn-block bg-dark"> <b>LOGout!</b></button>
                
              </form>
              <br></br>
              
              <h4 className="text-center text-black"> <b>WELCOME.....{this.props.name1} !</b></h4>
              <br></br>
              <br></br>
              <div className="card mb-3 mx-auto bg-dark" style={{ maxWidth: '512px' }}>
                <h2 className="text-center text-white text-monospace bg-dark"><b><ins>AID APPLICATIONS</ins></b></h2>
              ...
              <table className="table-sm table-bordered text-monospace" style={{ width: '1000px', maxHeight: '450px'}}>
                <thead style={{ 'fontSize': '15px' }}>
                  <tr className="bg-dark text-white">
                    <th className="text-right" scope="col" style={{ width: '10px'}}>id</th>
                  ...
                  return(
                    <thead style={{ 'fontSize': '12px' }} key={key}>
                      <tr>
                        ...
                        <td>
                        <Button2 text="Accept" id={file.fileId}/>
                          <Button text="Reject" id={file.fileId}/>
        ...
        {this.state.isToggleOn ? 'ON' : 'OFF'}
                  ...
                  //this.props.logout(password)
                    ...
                    <input
                        ...
                        placeholder =""
                        />
                    <h3 className="text-center text-white text-monospace bg-dark">STUDENT</h3>
                    {/* <p className="text-white text-monospace bg-dark">{ this.props.acc }</p> */}
                  {/* <input type="file" onChange={this.props.captureFile} className="text-white text-monospace"/> */}
                  <button type="submit" className="btn-primary btn-block bg-dark"> <b>LOGOUT</b></button>
                ...
                <br></br> <br></br> <br></br> 
                <div className="card mb-3 mx-auto bg-dark" style={{ maxWidth: '512px' }}>
                <h2 className="text-center text-white text-monospace bg-dark"><b><ins>Share File</ins></b></h2>
                  <form onSubmit={(event) => {
                    event.preventDefault()
                    const description = this.fileDescription.value
                    this.props.uploadFile(description)
                      ...
                      <p className="text-center text-white text-monospace bg-dark">{ this.props.acc }</p>
                    <input type="file" onChange={this.props.captureFile} className="text-white text-monospace"/>
                    <br></br>
                    <button type="submit" className="btn-primary btn-block"><b>Upload!</b></button>
                  </form>
              ...
              <p>&nbsp;</p>
              <center>
              <table className="table-sm table-bordered text-monospace" style={{ width: '1000px', maxHeight: '450px', marginLeft: '270px'}}>
